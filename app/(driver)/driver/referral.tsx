...
export default function ReferralScreen() {
    ...
    const handleShare = async () => {
        try {
            await Share.share({
                message: `Hey! Use my referral code ${referralCode} to sign up as a driver on GOGO and earn a bonus!`,
            });
        } catch (error) {
            console.error(error);
        }
            ...
            <View style={styles.content}>
                ...
                <Animated.View entering={FadeInDown.delay(300)} style={styles.textContainer}>
                    ...
                    <Text style={styles.subtitle}>
                        Share your code with friends and get <Text style={styles.highlight}>$50.00</Text> when they complete 10 rides!
                    </Text>
                </Animated.View>
                ...
                <Animated.View entering={FadeInDown.delay(400)} style={styles.codeContainer}>
                    ...
                    <TouchableOpacity style={styles.codeBox} onPress={handleCopy} activeOpacity={0.8}>
                        ...
                        <View style={styles.copyButton}>
                            <Ionicons name={copied ? "checkmark" : "copy-outline"} size={20} color={copied ? Colors.primary : Colors.text} />
